...
describe('FeatureFlagDirective', () => {
  ...
  function renderDirective() {
    ...
    return render(
      `<div *dsgFeatureFlag="some-flag" data-testid="renderedDiv">
      Feature
      </div>`,
      {
  ...
  it('when flag is disabled it should not show the div', async () => {
  ...
  it('when flag is enabled it should show the div', async () => {
    const { fixture } = await renderDirective();
